      ...
      <div className="w-full max-w-md overflow-hidden rounded-[2.4rem] bg-white shadow-2xl">
        ...
        <div className="space-y-4 p-5">
          ...
          {dialog.canRetry && onRetry ? (
            <button onClick={onRetry} disabled={retrying} className="w-full rounded-2xl border-2 border-saung-red bg-white px-5 py-3 font-black text-saung-red shadow-sm transition hover:bg-red-50 disabled:cursor-not-allowed disabled:opacity-60">
